...
import no.nav.syfo.application.IManglendeMedvirkningRepository
...
class ManglendeMedvirkningRepository(private val database: DatabaseInterface) : IManglendeMedvirkningRepository {
